...
この repo は NON PICKUP Rank 28 の閉域アルファ実装です。

## Scope

- Canonical path: `D:\AI\AdobePlugin\Lightroom\photo-selection-develop-evidence-panel`
- Repository: `Sunmax0731/photo-selection-develop-evidence-panel`
