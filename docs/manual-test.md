...
`D:\AI\AdobePlugin\Lightroom\photo-selection-develop-evidence-panel`

## 事前準備

1. GitHub Release `v0.1.0-alpha.1` から `dist/photo-selection-develop-evidence-panel-docs.zip` を取得できることを確認する。
...
5. 採用写真ごとに用途、現像メモ、再編集メモをレポート化する
